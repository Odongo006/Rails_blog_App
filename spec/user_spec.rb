...
RSpec.describe User, type: :model do
  ...
  describe 'recent_posts' do
    it 'returns up to three most recent posts' do
      subject.posts.create!(title: 'Post 1', text: 'Hello', created_at: 3.days.ago, comments_counter: 0,
                            likes_counter: 0)
      subject.posts.create!(title: 'Post 2', text: 'Toro', created_at: 2.days.ago, comments_counter: 0,
                            likes_counter: 0)
      subject.posts.create!(title: 'Post 3', text: 'How are you', created_at: 1.day.ago, comments_counter: 0,
                            likes_counter: 0)
